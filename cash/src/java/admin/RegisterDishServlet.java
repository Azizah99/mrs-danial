 ...
 * @author MSI
 */
@WebServlet(name = "RegisterCurrencyServlet", urlPatterns = {"/admin/RegisterDishServlet"})
public class RegisterDishServlet extends HttpServlet {   
	...
	HttpSession session = request.getSession();
        ...
        System.out.println(" " + menu + " " + price + " " + category);
        String sqlInsert = "INSERT INTO dishes(menu, price, category, status) VALUES(?, ?, ?, 'active')"; 
