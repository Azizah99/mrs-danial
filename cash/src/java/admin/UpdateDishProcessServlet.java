 ...
 * @author MSI
 */
@WebServlet(name = "UpdateDishProcessServlet", urlPatterns = {"/admin/UpdateDishProcessServlet"})
public class UpdateDishProcessServlet extends HttpServlet {
	...
	HttpSession session = request.getSession();
        ...
        System.out.println("Id: " + id + " menu: " + menu + " price: " + price);
        String sqlUpdate = "UPDATE dishes SET menu= ?, price = ? WHERE id = ?"; 
