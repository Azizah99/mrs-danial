 ...
 * @author MSI
 */
@WebServlet(name = "DeactivateCurrencyServlet", urlPatterns = {"/admin/DeactivateCurrencyServlet"})
public class DeactivateCurrencyServlet extends HttpServlet {
	...
	HttpSession session = request.getSession();
        ...
        String sqlUpdate = "UPDATE currency SET status = 'deactivate' WHERE id = ?"; 
