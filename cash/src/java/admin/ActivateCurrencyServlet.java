 ...
 * @author MSI
 */
@WebServlet(name = "ActivateCurrencyServlet", urlPatterns = {"/admin/ActivateCurrencyServlet"})
public class ActivateCurrencyServlet extends HttpServlet {
	...
	HttpSession session = request.getSession();
        ...
        String sqlUpdate = "UPDATE currency SET status = 'active' WHERE id = ?"; 
