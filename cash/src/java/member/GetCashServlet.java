 ...
 * @author U
 */
@WebServlet(name = "GetCashServlet", urlPatterns = {"/GetCashServlet"})
public class GetCashServlet extends HttpServlet {
	...
	HttpSession session = request.getSession();
        ...
        response.sendRedirect(request.getContextPath() + "/getcash.jsp");        
    }
