<%-- 
    Document   : orderlist
    Created on : Jan 26, 2021, 12:44:40 PM
    Author     : Lenovo
--%>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li><a href="/cash/ViewDishServlet"><span class="glyphicon glyphicon-th-list"></span> View Dish</a></li> 
                    <li><a href="/cash/ViewCartServlet"><span class="glyphicon glyphicon-th-list"></span> View Cart</a></li>
                    <li  class="active"><a href="/cash/ViewOrderServlet"><span class="glyphicon glyphicon-th-list"></span> View Order</a></li>
                </ul>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-hover ">
                        <thead>
                            ...
                            <tbody>
                                 <c:forEach items="${sessionScope.orList}" var="currentorder" varStatus="loop">
                                     <tr> 
                                          
                                        <td><c:out value="${currentorder.menu}" /></td>
                                        <td><c:out value="${currentorder.quantity}" /></td>
                                        <td><c:out value="${currentorder.status}" /></td>
                                </c:forEach> 
